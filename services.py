...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(f", ".join(chat_ids))
...
async def top_products(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await get_products("http://172.18.0.1:8000/api/products/?ordering=-cost", update, context)


async def popular_products(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await get_products("http://172.18.0.1:8000/api/products/popular", update, context)
